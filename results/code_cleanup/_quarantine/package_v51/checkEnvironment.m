...
arguments
    outputFile (1,1) string = fullfile(v51.projectRoot(),"results","v5_1", ...
        "logs","environment_report.txt")
end
root = v51.projectRoot();
cfg = v51.loadConfiguration("fbwa_roll_step");
...
try
    ...
    wslReport = string(v51.invokePowerShell(script,["-Distro", ...
...
if fid < 0, error("UAVV51:EnvironmentReport","Cannot write %s",filePath); end
